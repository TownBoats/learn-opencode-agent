...
- `SILICONFLOW_API_KEY`：仅在涉及 Embedding/向量请求的脚本中校验，包括 `v1_chunk_problem.py`、`v2_embedding_problem.py`、`v3_hybrid_search.py` 与 `production_rag.py`；其余脚本（如 `v4_prompt_control.py`、`v5_metadata_conflict.py`）只需 `DEEPSEEK_API_KEY`。
